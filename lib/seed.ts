...
const SEEDS: SeedArgs[] = [
  ...
  // Demo pharmacist-portal account holder (Emmanuel Momo), mirrors his portal
  // application; resolved as LPB-2026-0027.
  { status: "submitted", at: "2026-07-17T09:45:00Z", title: "Mr.", first: "Emmanuel", mid: "K.", last: "Momo", dob: "1989-06-14", gender: "Male", origin: "Montserrado", marital: "Married", email: "emmanuel.momo@example.lr", phone: "+231 77 555 0143", address: "Duport Road, near Rehab Junction", city: "Paynesville", district: "Paynesville", resCounty: "Montserrado", qual: "Bachelor of Pharmacy (BPharm)", school: "University of Liberia, School of Pharmacy", country: "Liberia", grad: "2014", spec: "Pharmacy", lpb: "RPh-0338", cat: "Registered Pharmacist", regYear: "2017", expiry: "2027-06-30", elsewhere: "Ghana", emp: "Employed", sector: "Private Community (Retail) Pharmacy", facility: "CareWell Pharmacy, Duport Road", ftype: "Community Pharmacy", position: "Pharmacist-in-Charge", pCounty: "Montserrado", pDistrict: "Paynesville", years: "11", withCv: true, notes: "Demo portal account application; trial submissions from the pharmacist portal update this record (reference stays LPB-2026-0027)." },
];
